...
/** Total height that needs to be added to squares to connect them upwards diagonally */
VERTICAL_TILE_CONNECTION_HEIGHT = CONNECTION_PEG_HEIGHT + DIP_DIMENSIONS;
/** Height of connection columns in number of squares (for multi-level buildings this is the standard height of one floor) */
CONNECTION_COLUMN_HEIGHT = 3;
 ...
 */
module connection_shape(_center=true) {
